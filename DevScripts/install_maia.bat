...
set NUGET_OUTPUT_DIR=..\DevScripts\nupkg

echo.
echo === 1. Rebuildando Wolfish.Maia em modo Release... ===
echo.
...
echo.
echo === 2. Empacotando Wolfish.Maia em modo Release... ===
echo.
...
echo.
echo === 4. Instalando a nova versão globalmente a partir da fonte local... ===
echo.
